...
import { LayoutDashboard, Plus, Settings, LogOut, ChevronDown, Menu } from 'lucide-react';
...
export default function PanelLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <aside className={`w-64 bg-white border-r border-gray-200 shadow-sm flex flex-col ${asideOpen ? 'block' : 'hidden'}`}>
        {/* Logo Section */}
